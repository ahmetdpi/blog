...
<body>
<nav
    class="sticky top-0 z-50 flex items-center justify-between w-full h-18 px-6 md:px-16 lg:px-24 xl:px-32 backdrop-blur">
    <a href="#!">
...
{{--        <button class="px-6 py-2 bg-indigo-600 hover:bg-indigo-700 transition text-white rounded-md active:scale-95">--}}
{{--            Get started--}}
{{--        </button>--}}
{{--        <button class="hover:bg-slate-300/20 transition px-6 py-2 border border-slate-400 rounded-md active:scale-95">--}}
{{--            Login--}}
{{--        </button>--}}
{{--    </div>--}}
    <button class="lg:hidden active:scale-90 transition" id="menu-button">
        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none"
             stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
             class="lucide lucide-menu size-6.5" aria-hidden="true">
            <path d="M4 5h16"></path>
...
<div id="nav-links" class="fixed inset-0 z-[100] bg-black/60 backdrop-blur flex flex-col items-center justify-center text-lg gap-8 lg:hidden transition-transform duration-400 -translate-x-full">
...
<!-- Hero Section -->
<section class="flex flex-col items-center -mt-18">
    <svg class="absolute -z-10 w-full -mt-40 md:mt-0" width="1440" height="676" viewBox="0 0 1440 676" fill="none" xmlns="http://www.w3.org/2000/svg">
        <rect x="-92" y="-948" width="1624" height="1624" rx="812" fill="url(#a)"></rect>
        <defs>
            <radialGradient id="a" cx="0" cy="0" r="1" gradientUnits="userSpaceOnUse"
                            gradientTransform="rotate(90 428 292)scale(812)">
                <stop offset=".63" stop-color="#372AAC" stop-opacity="0"></stop>
                <stop offset="1" stop-color="#372AAC"></stop>
            </radialGradient>
        </defs>
    </svg>
...
<section class="flex flex-col items-center" id="creations">
    <div class="flex flex-col items-center mt-32">
        <h2 class="text-center text-4xl font-semibold max-w-2xl">
            {{ $settings['creations_title'] ?? 'Our latest creation' }}
        </h2>
        <p class="text-center text-slate-400 max-w-lg mt-3">
            {{ $settings['creations_description'] ?? 'A visual collection of our most recent works - each piece crafted with intention, emotion, and style.' }}
        </p>
    </div>
    <div class="flex items-center gap-4 h-100 w-full max-w-5xl mt-18 mx-auto">

        <a href="{{ route('country.show', 'vietnam') }}" class="relative group flex-grow h-[400px] rounded-xl overflow-hidden hover:w-full w-56 transition-all duration-500 block">
            <img class="h-full w-full object-cover object-center" alt="Country-1"
                 src="{{ $settings['creations_country_image1'] ?? 'https://images.unsplash.com/photo-1543269865-0a740d43b90c?q=80&w=800&h=400&auto=format&fit=crop' }}" />
            <div class="absolute inset-0 flex flex-col justify-end p-10 text-white bg-black/50 transition-all duration-300 opacity-0 group-hover:opacity-100">
                <h1 class="text-3xl font-semibold">{{ $settings['creations_country_title1'] ?? 'HATA' }}</h1>
                <p class="text-sm mt-2">{{ $settings['creations_country_description1'] ?? 'HATA' }}</p>
            </div>
        </a>

        <a href="{{ route('country.show', 'thailand') }}" class="relative group flex-grow h-[400px] rounded-xl overflow-hidden hover:w-full w-56 transition-all duration-500 block">
            <img class="h-full w-full object-cover object-right" alt="Country-2"
                 src="{{ $settings['creations_country_image2'] ?? 'https://images.unsplash.com/photo-1714976326351-0ecf0244f0fc?q=80&w=800&h=400&auto=format&fit=crop' }}" />
            <div class="absolute inset-0 flex flex-col justify-end p-10 text-white bg-black/50 transition-all duration-300 opacity-0 group-hover:opacity-100">
                <h1 class="text-3xl font-semibold">{{ $settings['creations_country_title2'] ?? 'HATA' }}</h1>
                <p class="text-sm mt-2">{{ $settings['creations_country_description2'] ?? 'HATA' }}</p>
            </div>
        </a>

        <a href="{{ route('country.show', 'cambodia') }}" class="relative group flex-grow h-[400px] rounded-xl overflow-hidden hover:w-full w-56 transition-all duration-500 block">
            <img class="h-full w-full object-cover object-center" alt="Country-3"
                 src="{{ $settings['creations_country_image3'] ?? 'https://images.unsplash.com/photo-1736220690062-79e12ca75262?q=80&w=800&h=400&auto=format&fit=crop' }}" />
            <div class="absolute inset-0 flex flex-col justify-end p-10 text-white bg-black/50 transition-all duration-300 opacity-0 group-hover:opacity-100">
                <h1 class="text-3xl font-semibold">{{ $settings['creations_country_title3'] ?? 'HATA' }}</h1>
                <p class="text-sm mt-2">{{ $settings['creations_country_description3'] ?? 'HATA' }}</p>
            </div>
        </a>

        <a href="{{ route('country.show', 'maleysia') }}" class="relative group flex-grow h-[400px] rounded-xl overflow-hidden hover:w-full w-56 transition-all duration-500 block">
            <img class="h-full w-full object-cover object-center" alt="Country-4"
                 src="{{ $settings['creations_country_image4'] ?? 'https://images.unsplash.com/photo-1736220690062-79e12ca75262?q=80&w=800&h=400&auto=format&fit=crop' }}" />
            <div class="absolute inset-0 flex flex-col justify-end p-10 text-white bg-black/50 transition-all duration-300 opacity-0 group-hover:opacity-100">
                <h1 class="text-3xl font-semibold">Diğer</h1>
                <p class="text-sm mt-2">Diğer ülkelerden yazılar.</p>
            </div>
        </a>
...
<section class="flex flex-col items-center" id="about">
    <div class="flex flex-col items-center mt-32">
        <h2 class="text-center text-4xl font-semibold max-w-2xl">
            {{ $settings['about_title'] ?? 'About our apps' }}
        </h2>
        <p class="text-center text-slate-400 max-w-lg mt-3">
            {{ $settings['about_description'] ?? 'A visual collection of our most recent works - each piece crafted with intention, emotion, and style.' }}
        </p>
    </div>
...
<section class="flex flex-col items-center" id="testimonials">
    <div class="flex flex-col items-center mt-32">
        <h2 class="text-center text-4xl font-semibold max-w-2xl">
            {{ $settings['testimonials_title'] ?? 'Our testimonials' }}
        </h2>
        <p class="text-center text-slate-400 max-w-lg mt-3">
            {{ $settings['testimonials_description'] ?? 'A visual collection of our most recent works - each piece crafted with intention, emotion, and style.' }}
        </p>
    </div>
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 mt-18 max-w-6xl mx-auto">
        <div class="group border border-slate-800 p-6 rounded-xl">
            ...
            <div class="flex items-center gap-3 mt-8 group-hover:-translate-y-1 duration-300">
                <img class="size-10 rounded-full" alt="user image" src="https://images.unsplash.com/photo-1633332755192-727a05c4013d?q=80&w=200">
                <div>
        ...
        <div class="group border border-slate-800 p-6 rounded-xl">
            ...
            <div class="flex items-center gap-3 mt-8 group-hover:-translate-y-1 duration-300">
                <img class="size-10 rounded-full" alt="user image" src="https://images.unsplash.com/photo-1535713875002-d1d0cf377fde?q=80&w=200">
                <div>
        ...
        <div class="group border border-slate-800 p-6 rounded-xl">
            ...
            <div class="flex items-center gap-3 mt-8 group-hover:-translate-y-1 duration-300">
                <img class="size-10 rounded-full" alt="user image" src="https://images.unsplash.com/photo-1527980965255-d3b416303d12?w=200&auto=format&fit=crop&q=60">
                <div>
        ...
        <div class="group border border-slate-800 p-6 rounded-xl">
            ...
            <div class="flex items-center gap-3 mt-8 group-hover:-translate-y-1 duration-300">
                <img class="size-10 rounded-full" alt="user image" src="https://images.unsplash.com/photo-1522075469751-3a6694fb2f61?w=200&auto=format&fit=crop&q=60">
                <div>
        ...
        <div class="group border border-slate-800 p-6 rounded-xl">
            ...
            <div class="flex items-center gap-3 mt-8 group-hover:-translate-y-1 duration-300">
                <img class="size-10 rounded-full" alt="user image" src="https://images.unsplash.com/photo-1438761681033-6461ffad8d80?q=80&w=100&h=100&auto=format&fit=crop">
                <div>
        ...
        <div class="group border border-slate-800 p-6 rounded-xl">
            ...
            <div class="flex items-center gap-3 mt-8 group-hover:-translate-y-1 duration-300">
                <img class="size-10 rounded-full" alt="user image" src="https://raw.githubusercontent.com/prebuiltui/prebuiltui/main/assets/userImage/userImage1.png">
                <div>
...
<section class="flex flex-col items-center">
    <div class="flex flex-col items-center mt-32">
        <h2 class="text-center text-4xl font-semibold max-w-2xl" style="opacity: 1; transform: none;">Trusted
            <span class="bg-gradient-to-t from-indigo-600 to-black p-1 bg-left inline-block bg-no-repeat">companies</span>
        </h2>
    ...
    <div class="relative max-w-5xl py-20 md:py-26 mt-18 md:w-full overflow-hidden mx-2 md:mx-auto border border-indigo-900 flex flex-col md:flex-row items-center justify-between bg-gradient-to-br from-[#401B98]/5 to-[#180027]/10 rounded-3xl p-4 md:p-10 text-white">
        ...
        <div class="flex flex-col items-center md:items-start max-md:text-center">
            <a href="#!" class="group flex items-center gap-2 rounded-full text-sm p-1 pr-3 text-indigo-300 bg-indigo-200/15">
                <span class="bg-indigo-600 text-white text-xs px-3.5 py-1 rounded-full">NEW</span>
                <p class="flex items-center gap-1">
                    <span>Try 30 days free trial option</span>
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-chevron-right group-hover:translate-x-0.5 transition duration-300">
                        <path d="m9 18 6-6-6-6"></path>
                    </svg>
                </p>
            </a>
            <h1 class="text-3xl font-medium max-w-xl mt-5 bg-gradient-to-r from-white to-[#b6abff] text-transparent bg-clip-text">
                Trusted by leading companies.
            </h1>
            <p class="text-base text-slate-400 max-w-lg mt-4">
        ...
        <div class="md:-mr-16 max-md:mt-10">
            <img class="max-w-xs md:max-w-sm" alt="" src="https://raw.githubusercontent.com/prebuiltui/prebuiltui/main/assets/trusted-brand/image-fc6e.png">
        </div>
    </div>
</section>
...
<section class="flex flex-col items-center" id="contact">
    <div class="flex flex-col items-center mt-32">
        <h2 class="text-center text-4xl font-semibold max-w-2xl">
            Get in
            <span class="bg-gradient-to-t from-indigo-600 to-black p-1 bg-left inline-block bg-no-repeat">touch</span>
        </h2>
        <p class="text-center text-slate-400 max-w-lg mt-3">A visual collection of our most recent works - each piece crafted with intention, emotion, and style.</p>
    </div>
    <form class="grid sm:grid-cols-2 gap-3 sm:gap-5 max-w-3xl mx-auto text-slate-400 mt-16 w-full">
        <div>
            <label class="font-medium text-slate-200">Your name</label>
            <input placeholder="Enter your name" class="w-full mt-2 p-3 outline-none border border-slate-700 rounded-lg focus-within:ring-1 transition focus:ring-indigo-600" type="text" name="name">
        </div>
        <div>
            <label class="font-medium text-slate-200">Email id</label>
            <input placeholder="Enter your email" class="w-full mt-2 p-3 outline-none border border-slate-700 rounded-lg focus-within:ring-1 transition focus:ring-indigo-600" type="email" name="email">
        </div>
        <div class="sm:col-span-2">
            <label class="font-medium text-slate-200">Message</label>
            <textarea name="message" rows="8" placeholder="Enter your message" class="resize-none w-full mt-2 p-3 outline-none rounded-lg focus-within:ring-1 transition focus:ring-indigo-600 border border-slate-700"></textarea>
        </div>
        <button type="submit" class="w-max flex items-center gap-2 bg-indigo-600 hover:bg-indigo-700 text-white px-8 py-3 rounded-full">
            Submit
